  ...
  fields: [
    {
      ...
      required: false,
      hint:
        "If an ID is specified, an accompanying marker should be placed in the text.",
    },
    {
      name: "margin",
      ...
      widget: "boolean",
      required: false,
      hint: "Display as a margin note unconnected to the main text",
    },
    {
      name: "content",
      label: "Sidenote content",
      widget: "text",
      minimal: true,
